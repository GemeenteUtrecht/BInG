...
os.environ.setdefault(
    "SECRET_KEY", "v1zy5$p*a5s^9_7r!z9d30jyvpa6oj6j(ie#gpt*z=$&ojkwd0"
)

# uses postgresql by default, see base.py
os.environ.setdefault("DB_NAME", "bing"),
os.environ.setdefault("DB_USER", "bing"),
os.environ.setdefault("DB_PASSWORD", "bing"),
...
LOGGING["loggers"].update(
    {
        "bing": {"handlers": ["console"], "level": "DEBUG", "propagate": True},
