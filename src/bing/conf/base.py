...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "bing"),
        "USER": os.getenv("DB_USER", "bing"),
        "PASSWORD": os.getenv("DB_PASSWORD", "bing"),
...
WSGI_APPLICATION = "bing.wsgi.application"
...
DEFAULT_FROM_EMAIL = "bing@example.com"
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "bing.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
    ...
    "loggers": {
        "bing": {"handlers": ["project"], "level": "INFO", "propagate": True},
